...
import it.ezzie.myapplist.databinding.ActivityBlueCalculatorBinding;

public class MainActivity_Blue_Calculator extends AppCompatActivity {

    private ActivityBlueCalculatorBinding blueBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blueBinding = ActivityBlueCalculatorBinding.inflate(getLayoutInflater());
        setContentView(blueBinding.getRoot());

        blueBinding.actRed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity_Blue_Calculator.this, MainActivity_Red_Calculator.class);
                startActivity(i);
            }
        });
    ...
    public void onOperatorClicked(View view){
        ...
        //Adding the current value to the intList
        if(operator.equals("=")){
            try {
                String input = blueBinding.etCalculate.getText().toString();
                if(input.isEmpty()){
